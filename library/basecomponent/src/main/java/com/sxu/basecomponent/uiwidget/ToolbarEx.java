...
import com.sxu.basecomponent.activity.BaseCommonActivity;
...
public class ToolbarEx extends Toolbar {
	...
	public ToolbarEx(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
		...
		if (context instanceof BaseCommonActivity && ((BaseCommonActivity) context).isImmersionStatus()) {
		...
		setReturnIcon(R.drawable.nav_back_white_icon);
		setTitle("");
...
//		});
	...
	private void initReturnIcon() {
		if (returnIcon == null) {
			...
			int padding = DisplayUtil.dpToPx(16);
...
//		setNavigationOnClickListener(listener);
	...
	public ToolbarEx setRightIcon(@DrawableRes int resId, OnClickListener listener) {
		return setRightIcon(resId, DisplayUtil.dpToPx(24), 0, listener);
	}
	...
	public ToolbarEx setRightIcons(@DrawableRes int[] resIds, OnClickListener[] listeners) {
		return setRightIcons(resIds, DisplayUtil.dpToPx(8), DisplayUtil.dpToPx(12), listeners);
	}

	public ToolbarEx setRightIcons(@DrawableRes int[] resIds, int horizontalPadding, OnClickListener[] listeners) {
		return setRightIcons(resIds, horizontalPadding, DisplayUtil.dpToPx(12), listeners);
	}
