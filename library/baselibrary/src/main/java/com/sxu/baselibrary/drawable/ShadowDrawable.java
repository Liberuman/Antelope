package com.sxu.baselibrary.drawable;
...
public class ShadowDrawable extends Drawable {
	...
	public static void setShadowDrawable(View view, int shapeRadius, int shadowColor, int shadowRadius, int offsetX, int offsetY) {
		Drawable drawable = getShadowDrawable(shapeRadius, shadowColor, shadowRadius, offsetX, offsetY);
		setShadowDrawable(view, drawable);
	}
	...
	public static void setShadowDrawable(View view, int bgColor, int shapeRadius, int shadowColor, int shadowRadius, int offsetX, int offsetY) {
		Drawable drawable = getShadowDrawable(bgColor, shapeRadius, shadowColor, shadowRadius, offsetX, offsetY);
		setShadowDrawable(view, drawable);
	}
	...
	public static void setShadowDrawable(View view, int shape, int bgColor, int shapeRadius, int shadowColor, int shadowRadius, int offsetX, int offsetY) {
		Drawable drawable = getShadowDrawable(shape, bgColor, shapeRadius, shadowColor, shadowRadius, offsetX, offsetY);
		setShadowDrawable(view, drawable);
	}
	...
	public static Drawable getShadowDrawable(int shapeRadius, int shadowColor, int shadowRadius, int offsetX, int offsetY) {
		return getShadowDrawable(SHAPE_ROUND, Color.TRANSPARENT, shapeRadius, shadowColor, shadowRadius, offsetX, offsetY);
	}

	public static Drawable getShadowDrawable(int bgColor, int shapeRadius, int shadowColor, int shadowRadius, int offsetX, int offsetY) {
		return getShadowDrawable(SHAPE_ROUND, bgColor, shapeRadius, shadowColor, shadowRadius, offsetX, offsetY);
	}
	 ...
	 * @return
	 */
	public static Drawable getShadowDrawable(int shape, int bgColor, int shapeRadius, int shadowColor, int shadowRadius, int offsetX, int offsetY) {
		return new ShadowDrawable.Builder()
			.setShape(shape)
			.setBgColor(bgColor)
