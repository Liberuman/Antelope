...
/*******************************************************************************
 * Description: 使用ViewModel+DataBinding的List类型的Fragment的基础类
 *
 * Author: Freeman
 *
 * Date: 2021/10/12
 ...
 *******************************************************************************/
public abstract class MyBaseVMListFragment<T, VB extends ViewDataBinding, VM extends ViewModel> extends BaseCommonListFragment<T> implements IBaseVM {
