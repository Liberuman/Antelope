...
public class GridSpaceItemDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * @param spacing     item 间距
     * @param edgeSpacing item 距屏幕周围的间距
     */
    public GridSpaceItemDecoration(int spacing, int edgeSpacing) {
        this.mSpacing = spacing;
        this.mIncludeEdge = edgeSpacing > 0;
        this.mEdgeSpacing = edgeSpacing;
    }

    public GridSpaceItemDecoration setOrientation(int orientation) {
            ...
            if (mIncludeEdge) {
                ...
                if (spanGroupIndex > -1) {
                    ...
                    if (spanGroupIndex < 1 && position < mSpanCount) {
                        if (mOrientation == RecyclerView.VERTICAL) {
                            // 第一行才有上间距
                            outRect.top = mEdgeSpacing > 0 ? mEdgeSpacing : mSpacing;
                        } else {
                            // 第一列才有左间距
                            outRect.left =  mEdgeSpacing > 0 ? mEdgeSpacing : mSpacing;
                        }
                    }
                } else {
